...
jQuery(document).ready(function ($) {
    ...
    /*----------------------------------------------------*/
    /*  Google Map
    Edf Ametista: -8.117237, -34.899104
    ------------------------------------------------------*/

    // main directions   
    map = new GMaps({
        el: '#map', lat: -8.117237, lng: -34.899104, zoom: 13, zoomControl: true,
        zoomControlOpt: { style: 'SMALL', position: 'TOP_LEFT' }, panControl: false, scrollwheel: false
    });
    // add address markers
    map.addMarker({
        lat: -8.117237, lng: -34.899104, title: 'Escritório',
        infoWindow: { content: '<p>Escritório em Recife</p>' }
    });
